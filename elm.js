...
var $author$project$Game$empty = {areas: $elm$core$Set$empty, level: 0};
...
var $author$project$View$Level$area = function (args) {
	var _v0 = args.center;
	var x = _v0.a;
	var y = _v0.b;
		...
		_Utils_ap(
			...
			_List_fromArray(
				[
					...
					'clip-path',
					'circle(' + ((args.visible ? $elm$core$String$fromFloat($author$project$Config$screenMinHeight) : $elm$core$String$fromFloat(0)) + ('px at ' + ($elm$core$String$fromInt(x) + ('px ' + ($elm$core$String$fromInt(y) + 'px)'))))))
				])));
};
...
var $author$project$View$Level$base = function (bool) {
	return A2(
...
var $author$project$View$Level$button = F3(
	function (bool, attrs, onPress) {
		return A2(
...
var $author$project$Game$Level1$secondButton = function (bool) {
	return A2(
		$author$project$View$Level$button,
		bool,
		_List_fromArray(
...
var $author$project$Game$Level2$buttomSquare = function (color) {
	return A2(
		$Orasund$elm_layout$Layout$el,
		_List_fromArray(
			[
...
var $author$project$Game$Level2$leftSquare = function (bool) {
	return A2(
		$Orasund$elm_layout$Layout$el,
		_List_fromArray(
			[
...
var $author$project$Game$Level2$rightSquare = function (bool) {
	return A2(
		$Orasund$elm_layout$Layout$el,
		_List_fromArray(
			[
...
var $author$project$Game$Level2$path = function (bool) {
	return A2(
		$Orasund$elm_layout$Layout$el,
		_List_fromArray(
			[
...
var $author$project$Game$Level2$secondButton = function (bool) {
	return A2(
		$author$project$View$Level$button,
		bool,
		_List_fromArray(
...
var $author$project$Game$Level2$toggle = function (args) {
	var _v0 = args.color;
	if (_v0.$ === 'Blue') {
		return A2(
			$author$project$View$Level$area,
			{center: args.center, transition: args.transition, visible: args.visible},
			_List_fromArray(
				[
...
var $author$project$Game$Level2$toHtml = function (args) {
	...
	return _List_fromArray(
		[
			$author$project$View$Level$base($author$project$Game$Blue),
			$author$project$Game$Level2$buttomSquare($author$project$Game$Yellow),
			...
			_List_fromArray(
				[
					$author$project$Game$Level2$leftSquare($author$project$Game$Blue)
				])),
			A2(
			$author$project$View$Level$area,
			{
			...
			_List_fromArray(
				[
					$author$project$Game$Level2$rightSquare($author$project$Game$Blue)
				])),
		...
		[
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'left',
					$elm$core$String$fromInt(x - 25) + 'px'),
					A2(
					$elm$html$Html$Attributes$style,
					'background-color',
...
var $author$project$View$Level$downwardsHalfCircle = function (args) {
	var _v0 = args.pos;
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'height',
				$elm$core$String$fromInt(args.radius) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'width',
				...
				$elm$html$Html$Attributes$style,
				'border-radius',
				'0 0 ' + ($elm$core$String$fromInt(args.radius) + ('px ' + ($elm$core$String$fromInt(args.radius) + 'px')))),
				A2(
				$elm$html$Html$Attributes$style,
				'background-color',
				$author$project$View$color(args.color))
...
var $author$project$View$Level$downwardsHugeButton = function (args) {
	var _v0 = args.pos;
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
...
var $author$project$View$Level$upwardsButton = function (args) {
	var _v0 = args.pos;
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
...
var $author$project$View$Level$upwardsHalfCircle = function (args) {
	var _v0 = args.pos;
	var x = _v0.a;
	var y = _v0.b;
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'border-radius',
				$elm$core$String$fromInt(args.radius) + ('px ' + ($elm$core$String$fromInt(args.radius) + 'px 0 0'))),
				A2(
				$elm$html$Html$Attributes$style,
				'background-color',
				$author$project$View$color(args.color))
...
var $author$project$Game$Level3$toHtml = function (args) {
	return _Utils_ap(
		_List_fromArray(
			[
				$author$project$View$Level$base($author$project$Game$Blue),
				$author$project$View$Level$upwardsHalfCircle(
				{
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$author$project$View$Level$area,
						{
							center: _Utils_Tuple2(($author$project$Config$screenMinWidth / 2) | 0, (($author$project$Config$screenMinHeight / 2) | 0) - 100),
							transition: A2($elm$core$Set$member, 1, args.transitioningArea),
							visible: A2($elm$core$Set$member, 1, args.areas)
						},
						_List_fromArray(
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$View$Level$downwardsHalfCircle(
									{
										color: $author$project$Game$Blue,
										pos: _Utils_Tuple2(($author$project$Config$screenMinWidth / 2) | 0, ($author$project$Config$screenMinHeight / 2) | 0),
										radius: ($author$project$Config$screenMinWidth / 2) | 0
							...
							{
								center: _Utils_Tuple2(($author$project$Config$screenMinWidth / 2) | 0, ($author$project$Config$screenMinHeight / 2) | 0),
								transition: A2($elm$core$Set$member, 4, args.transitioningArea),
								visible: !A2($elm$core$Set$member, 4, args.areas)
							},
							_List_fromArray(
								[
									$author$project$View$Level$base($author$project$Game$Blue)
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Attributes$style,
				'width',
				$elm$core$String$fromInt(($author$project$Config$screenMinWidth / 2) | 0) + 'px'),
				A2(
				$elm$html$Html$Attributes$style,
				'height',
				$elm$core$String$fromInt($author$project$Config$screenMinHeight - 150) + 'px'),
				A2($elm$html$Html$Attributes$style, 'position', 'absolute'),
...
var $author$project$View$Level$upwardsBigButton = function (args) {
	var _v0 = args.pos;
	var x = _v0.a;
	var y = _v0.b;
	return _List_fromArray(
				...
				$author$project$View$Level$downwardsButton(
					{
						...
						onPress: $elm$core$Maybe$Just(
							args.onPress(
								_List_fromArray(
									[3]))),
						pos: _Utils_Tuple2(75, (($author$project$Config$screenMinHeight / 2) | 0) - 100)
					}),
				_Utils_ap(
					$author$project$View$Level$downwardsButton(
						{
							...
							onPress: $elm$core$Maybe$Just(
								args.onPress(
									_List_fromArray(
										[4]))),
							pos: _Utils_Tuple2($author$project$Config$screenMinWidth - 75, (($author$project$Config$screenMinHeight / 2) | 0) - 100)
						}),
					_List_fromArray(
						[
							A2(
							$author$project$View$Level$area,
							{
								center: _Utils_Tuple2(75, (($author$project$Config$screenMinHeight / 2) | 0) - 100),
								transition: A2($elm$core$Set$member, 3, args.transitioningArea),
								visible: !A2($elm$core$Set$member, 3, args.areas)
							},
							_List_fromArray(
							...
							$author$project$View$Level$area,
							{
								center: _Utils_Tuple2($author$project$Config$screenMinWidth - 75, (($author$project$Config$screenMinHeight / 2) | 0) - 100),
								transition: A2($elm$core$Set$member, 4, args.transitioningArea),
								visible: !A2($elm$core$Set$member, 4, args.areas)
							},
							_List_fromArray(
							...
							$author$project$View$Level$area,
							{
								...
								transition: A2($elm$core$Set$member, 2, args.transitioningArea),
								visible: A2($elm$core$Set$member, 2, args.areas) || (!A2($elm$core$Set$member, 0, args.areas))
							},
...
var $author$project$Game$new = F2(
	function (areas, level) {
		return {areas: areas, level: level};
	});
var $author$project$Level$toGame = function (_int) {
	return A2(
		$elm$core$Maybe$map,
		function (_v0) {
			var init = _v0.init;
			return A2($author$project$Game$new, init, _int);
		},
...
var $author$project$Game$applyButton = F2(
	function (i, game) {
